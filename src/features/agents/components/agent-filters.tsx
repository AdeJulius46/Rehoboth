...
const TYPE_ITEMS = { all: "All Type", SALES: "Sales Agent", COLLECTION: "Collection Agent" };
...
export function AgentFilters() {
  ...
  return (
    <>
      <Select
        items={TYPE_ITEMS}
        value={params.agentType ?? "all"}
        onValueChange={(value) => setParams({ agentType: !value || value === "all" ? undefined : value })}
      >
